...
object Data {
    ...
    val maybe = arrayOf(
        ...
        "I would give you an answer, but you wouldn't understand anyways.",
        "The answer definitely is \"kebab\"",
        "Please speak a little louder",
        "I'm really busy rn, please ask me later",
    ...
    val vielleicht = arrayOf(
        ...
        "Hä was",
        "ok",
        "Warum soll ich dir das jetzt sagen?",
        "Sorry, habe nicht zu gehört",
        "Ich würde dir ja antworten, aber du wirst es sowieso nicht verstehen.",
        "Die Antwort ist eindeutig \"Döner\"",
        "Lauter, bitte",
        "Ich bin gerade beschäftigt, frag mich später nochmal",
        "Noli turbare circulos meos",
        "Woher soll ich das denn wissen?",
        "Sei ganz ehrlich, du kennst die Antwort",
    ...
    val cicero = """
            ...
            Quotiens tibi iam extorta est ista sica de manibus, quotiens [vero] excidit casu aliquo et elapsa est! [tamen ea carere diutius non potes] quae quidem quibus abs te initiata sacris ac devota sit, nescio, quod eam necesse putas esse in consulis corpore defigere.
            ...
            Sed, si quis est invidiae metus, non est vehementius severitatis ac fortitudinis invidia quam inertiae ac nequitiae pertimescenda. An, cum bello vastabitur Italia, vestabuntur urbes, tecta ardebunt tum te non existimas invidiae incendio conflagraturum?"
    ...
    val zz = fromURL("https://pastebin.com/raw/gE8J93VQ")
    ...
    val trumptwitter = fromURL("https://raw.githubusercontent.com/harshilkamdar/trump-tweets/master/trump.txt")

    private fun fromURL(url: String): String = URL(url).readText()
}